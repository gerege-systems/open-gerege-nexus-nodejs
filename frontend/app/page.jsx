...
const trustPoints = ["website.trust.cookie", "website.trust.rbac", "website.trust.allowlist", "website.trust.audit"];
export default function LandingPage() {
    const { t } = useI18n();
    return <div className="gp-landing" id="top">
  <header className="gp-nav"><a href="#top" className="gp-brand"><img src="/brand.webp" alt=""/><span>Gerege Nexus</span></a><nav><a href="#features">{t("website.menu.features")}</a><a href="#trust">{t("website.menu.trust")}</a></nav><div className="gp-actions"><LanguageSwitcher variant="dark"/><Link href="/login" className="gp-gold">{t("website.action.sign_in")}</Link></div></header>
  <main>
